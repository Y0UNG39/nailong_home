...
exports.main=async(e)=>{
  ...
  try{
    ...
    for(const a of A){
      ...
      switch(a.id.includes('sign')?'sign':a.id.includes('shop')?'shop':a.id.includes('dream')?'dream':a.id.includes('day')?'days':a.id.includes('task')?'task':a.id.includes('complete')?'complete':a.id.includes('reconcile')?'reconcile':'other'){
